...
import { Package, MessageCircle, Zap, ShoppingCart } from 'lucide-react';
...
const NewArrivals = ({ onWhatsAppOrder }: NewArrivalsProps) => {
  const { user } = useAuth();
    ...
    <section className="py-8 md:py-20 px-4 bg-background">
      <div className="container mx-auto">
        <div className="text-center mb-6 md:mb-12">
          ...
          <h2 className="text-2xl md:text-4xl font-serif text-foreground mb-2">New Arrivals</h2>
